...
int main ()
{
  ...
  **/
  ...
  pid_steer.Init(0.001, 0.001, 0.005, 1.2, -1.2);
  pid_throttle.Init(0.006, 0.008, 0.008, 1.0, -1.0);
...
//           // Update the delta time with the previous command
          ...
          **/
          ...
          //Throttle Error is the difference between
          //the current velocity and the  desire
          //velocity (calculated by the path planner)
          //
